...
typedef AlarmStr AlarmArray [15+1-0];
...
typedef struct CameraStr 
  {
    ...
    BOOL ProductOK;
    BOOL CameraOnline;
    DINT CameraErrorCode;
  } CameraStr;
#pragma pack(pop)

typedef CameraStr CameraData [4+1-1];

typedef UDINT RecieveCodeEnum; 
    #define NoProduct 0
    #define ProductOk 1
    #define ProductToWide 2
    #define ProductToLong 3

#pragma pack(push, 1)
typedef struct CameraScanStr 
  {
    RecieveCodeEnum ScanCode;
    DINT PosXas;
    DINT PosYas;
    DINT PosRas;
  } CameraScanStr;
...
#pragma pack(push, 1)
typedef struct DataAlgemeenMachine 
  {
    DINT LineSpeed;
    DINT SensorFilterTime;
    DINT SensorMaskTime;
    DINT DelayStartTmr;
  } DataAlgemeenMachine;
#pragma pack(pop)
...
#pragma pack(push, 1)
typedef struct DataDischargeConvStr 
  {
    DINT Spare3;
    DINT RotCorrAcc;
    DINT ProdTriggerOffset;
    DINT HandAutoBediening;
    DINT SpeedOffsetConv2;
    DINT Spare4;
    DINT Spare5;
    DINT Spare6;
    DINT Spare7;
    DINT Spare8;
    DINT SpareArray [20+1-0];
  } DataDischargeConvStr;
#pragma pack(pop)
...
typedef struct DataRecipeStr 
  {
    ...
    DataY_AxleStr Y_Axle;
    DataX_AxleStr X_Axle;
    DataCameraStr Camera;
  } DataRecipeStr;

#pragma pack(push, 1)
typedef struct DataTrayConvStr 
  {
    DINT StepSpeed;
    DINT StepAccDec;
    DINT StepOffset;
    ...
    DINT SpareArray1;
    DINT ProdTriggerOffset;
    DINT DelayTraysGiven;
    DINT StackOption;
    DINT SinglePackage;
    DINT SingleDistance;
    DINT SpareArray2;
    DINT SpareArray3;
    DINT ProdTriggerOffsetArray [5+1-0];
    DINT SpareArray [30+1-0];
  } DataTrayConvStr;
#pragma pack(pop)

typedef UDINT DivEnum; 
    #define eDiv1 0
    #define eDiv10 1
    #define eDiv100 2
    #define eDiv1000 3
...
typedef UDINT eTriggerType; 
    #define eX_Trigger 0
    #define eY_Trigger 1
    #define eWaste_Trigger 2
...
typedef UDINT RunningStateEnum; 
    ...
    #define eRunStatus 1
    #define eErrorStatus 2
    #define eNoodstop 3
    #define ePauseStatus 4
    #define eCleaningStatus 5
    #define eDriveOffStatus 6
    #define eLockStatus 7
    #define eNoodstopStatus 8
    #define eStartUpStatus 9
    #define eHandStatus 10

#pragma pack(push, 1)
typedef struct MachineDataStr 
  {
    DINT Reference_Amount;  //! <Type Comment="Hoeveel partijen moeten er gerefereerd worden" Name="MachineDataStr.Reference_Amount"/>
    DINT Act_Reference_Amount;  //! <Type Comment="Hoeveel partijen zijn er daadwerkelijk gerefereerd&#13;&#10;" Name="MachineDataStr.Act_Reference_Amount"/>
  } MachineDataStr;
#pragma pack(pop)
...
typedef struct GlobalDataStr 
  {
    ...
    struct gRunStatus 
    {
      ...
      RunningStateEnum gRunStatusCamera;
      RunningStateEnum gRunStatusXaxles [MaxCameras+1-0];
      RunningStateEnum gRunStatusInfeedConv;
      RunningStateEnum gRunStatusYaxles [MaxCameras+1-0];
    } gRunStatus;
    MachineDataStr gMachineData;
  } GlobalDataStr;
#pragma pack(pop)
...
typedef UDINT PauseFunctions; 
    #define NormalyClosed 0
    #define NormalyOpen 1
    #define Puls 2
...
#pragma pack(push, 1)
typedef struct StrCameraData 
  {
    DINT ProductIsScaned;
    DINT X_Position;
    DINT Y_Position;
  } StrCameraData;
#pragma pack(pop)

typedef CameraScanStr StrCameraDataBuffer [MaxCameras+1-0];
...
typedef DINT tAlarm [16+1-0];

typedef UDINT TeachEnum; 
    #define TeachIdel 0
    #define Teaching 1
    #define TeachMode 2
    #define TeachingReady 3

#pragma pack(push, 1)
typedef struct TriggerStr 
  {
