...
#pragma pack(push, 1)
  ...
  END_STRUCT;
#pragma pack(pop)
  AlarmArray : ARRAY [0..15] OF AlarmStr;
#pragma pack(push, 1)
  CameraStr : STRUCT
    Xposition : DINT;
    Yposition : DINT;
    ...
    ProductOK : BOOL;
    CameraOnline : BOOL;
    CameraErrorCode : DINT;
  END_STRUCT;
#pragma pack(pop)
  CameraData : ARRAY [1..4] OF CameraStr;
  RecieveCodeEnum :
  (
    NoProduct,
    ProductOk,
...
#pragma pack(push, 1)
  CameraScanStr : STRUCT
    ScanCode : RecieveCodeEnum;
    PosXas : DINT;
    PosYas : DINT;
    PosRas : DINT;
  END_STRUCT;
...
#pragma pack(push, 1)
  DataAlgemeenMachine : STRUCT
    LineSpeed : DINT;
    SensorFilterTime : DINT;
    SensorMaskTime : DINT;
    DelayStartTmr : DINT;
  END_STRUCT;
#pragma pack(pop)
#pragma pack(push, 1)
  DataCameraStr : STRUCT
    TriggerOffset : DINT;
  END_STRUCT;
#pragma pack(pop)
#pragma pack(push, 1)
  DataDischargeConvStr : STRUCT
    Spare3 : DINT;
    RotCorrAcc : DINT;
    ProdTriggerOffset : DINT;
    HandAutoBediening : DINT;
    SpeedOffsetConv2 : DINT;
    Spare4 : DINT;
    Spare5 : DINT;
    Spare6 : DINT;
    Spare7 : DINT;
    Spare8 : DINT;
    SpareArray : ARRAY [0..20] OF DINT;
  END_STRUCT;
#pragma pack(pop)
#pragma pack(push, 1)
...
#pragma pack(pop)
#pragma pack(push, 1)
  DataY_AxleStr : STRUCT
    Speed : DINT;
    AccDec : DINT;
  END_STRUCT;
#pragma pack(pop)
#pragma pack(push, 1)
  DataX_AxleStr : STRUCT
    Speed : DINT;
    AccDec : DINT;
  END_STRUCT;
#pragma pack(pop)
  DataRecipeStr : STRUCT
    ...
    Y_Axle : DataY_AxleStr;
    X_Axle : DataX_AxleStr;
    Camera : DataCameraStr;
  END_STRUCT;
#pragma pack(push, 1)
  DataTrayConvStr : STRUCT
    StepSpeed : DINT;
    StepAccDec : DINT;
    StepOffset : DINT;
    VertNewTray : DINT;
    SpareArray1 : DINT;
    ProdTriggerOffset : DINT;
    DelayTraysGiven : DINT;
    StackOption : DINT;
    SinglePackage : DINT;
    SingleDistance : DINT;
    SpareArray2 : DINT;
    SpareArray3 : DINT;
    ProdTriggerOffsetArray : ARRAY [0..5] OF DINT;
    SpareArray : ARRAY [0..30] OF DINT;
  END_STRUCT;
#pragma pack(pop)
  DivEnum :
  (
...
#pragma pack(push, 1)
  MachineDataStr : STRUCT
    Reference_Amount : DINT;  //! <Type Comment="Hoeveel partijen moeten er gerefereerd worden" Name="MachineDataStr.Reference_Amount"/>
    Act_Reference_Amount : DINT;  //! <Type Comment="Hoeveel partijen zijn er daadwerkelijk gerefereerd&#13;&#10;" Name="MachineDataStr.Act_Reference_Amount"/>
  END_STRUCT;
#pragma pack(pop)
#pragma pack(push, 1)
  GlobalDataStr : STRUCT
    ...
    gRunStatus : STRUCT
      ...
      gRunStatusCamera : RunningStateEnum;
      gRunStatusXaxles : ARRAY [0..MaxCameras] OF RunningStateEnum;
      gRunStatusInfeedConv : RunningStateEnum;
      gRunStatusYaxles : ARRAY [0..MaxCameras] OF RunningStateEnum;
    END_STRUCT;
    gMachineData : MachineDataStr;
  END_STRUCT;
#pragma pack(pop)
#pragma pack(push, 1)
  ImpClkStr : STRUCT
...
#pragma pack(pop)
#pragma pack(push, 1)
  StrCameraData : STRUCT
    ProductIsScaned : DINT;
    X_Position : DINT;
    Y_Position : DINT;
  END_STRUCT;
#pragma pack(pop)
  StrCameraDataBuffer : ARRAY [0..MaxCameras] OF CameraScanStr;
  t_e_VaranErrors :
  (
    _ClassOk,
