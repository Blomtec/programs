...
TYPE
  ...
  CltCh_DINT : STRUCT
    ...
    pCmd : ^SVRCHCMD;
  END_STRUCT;
  SvrCh_DivEnum : STRUCT
    pMeth : ^CHMETH;
    dData : DivEnum;
    pDsc : ^SVRDSC;
  END_STRUCT;
  CltCh_DivEnum : STRUCT
    pCh : ^SvrCh_DivEnum;
    dData : DivEnum;
    pCmd : ^SVRCHCMD;
  END_STRUCT;
  ...
  SvrChCmd_iprStates : STRUCT
    ...
    pDsc : ^SVRDSC;
  END_STRUCT;
  CltChCmd__DriveActValues : STRUCT
    pCh : ^SvrChCmd_iprStates;
    dData : iprStates;
    pCmd : ^_DriveActValues;
  END_STRUCT;
  CltChCmd__DriveASyncPara : STRUCT
    pCh : ^SvrChCmd_iprStates;
    dData : iprStates;
    pCmd : ^_DriveASyncPara;
  END_STRUCT;
  CltChCmd__DriveAxis : STRUCT
    pCh : ^SvrChCmd_iprStates;
    dData : iprStates;
    pCmd : ^_DriveAxis;
  END_STRUCT;
  ...
  CltChCmd__DriveMngBase : STRUCT
    ...
    pCmd : ^_DriveMngBase;
  END_STRUCT;
  CltChCmd__DriveParaBase : STRUCT
    pCh : ^SvrChCmd_iprStates;
    dData : iprStates;
    pCmd : ^_DriveParaBase;
  END_STRUCT;
  ...
  CltChCmd__Linker : STRUCT
    ...
    pCmd : ^_Linker;
  END_STRUCT;
  CltChCmd__LMC_MotorInfo : STRUCT
    pCh : ^SvrChCmd_DINT;
    dData : DINT;
    pCmd : ^_LMC_MotorInfo;
  END_STRUCT;
  ...
  END_STRUCT;
  CltChCmd_AlarmSleegersPara : STRUCT
    pCh : ^SvrChCmd_DINT;
    dData : DINT;
    pCmd : ^AlarmSleegersPara;
  END_STRUCT;
  CltChCmd_AlarmSleegersParameter : STRUCT
    pCh : ^SvrChCmd_DINT;
    dData : DINT;
    pCmd : ^AlarmSleegersParameter;
  END_STRUCT;
  CltChCmd_Banner_EZlight : STRUCT
    pCh : ^SvrChCmd_DINT;
    dData : DINT;
    pCmd : ^Banner_EZlight;
  END_STRUCT;
  CltChCmd_Camera_Master : STRUCT
    pCh : ^SvrChCmd_DINT;
    dData : DINT;
    pCmd : ^Camera_Master;
  END_STRUCT;
  CltChCmd_CheckData : STRUCT
    pCh : ^SvrChCmd_DINT;
    dData : DINT;
    pCmd : ^CheckData;
  END_STRUCT;
  CltChCmd_Claxon : STRUCT
    pCh : ^SvrChCmd_DINT;
    dData : DINT;
    pCmd : ^Claxon;
  END_STRUCT;
  ...
  CltChCmd_I2CCDIAS : STRUCT
    ...
    pCmd : ^I2CCDIAS;
  END_STRUCT;
  CltChCmd_InfeedBelt : STRUCT
    pCh : ^SvrChCmd_DINT;
    dData : DINT;
    pCmd : ^InfeedBelt;
  END_STRUCT;
  CltChCmd_MainRecipe : STRUCT
    pCh : ^SvrChCmd_DINT;
    dData : DINT;
    pCmd : ^MainRecipe;
  END_STRUCT;
  ...
  CltChCmd_MerkerEx : STRUCT
    ...
    pCmd : ^MerkerEx;
  END_STRUCT;
  CltChCmd_PositionFilterIFC : STRUCT
    pCh : ^SvrChCmd_DINT;
    dData : DINT;
    pCmd : ^PositionFilterIFC;
  END_STRUCT;
  CltChCmd_ProductTrigger : STRUCT
    pCh : ^SvrChCmd_DINT;
    dData : DINT;
    pCmd : ^ProductTrigger;
  END_STRUCT;
  CltChCmd_ProductTriggerCamera : STRUCT
    pCh : ^SvrChCmd_DINT;
    dData : DINT;
    pCmd : ^ProductTriggerCamera;
  END_STRUCT;
  ...
  CltChCmd_t_e_VaranErrors : STRUCT
    ...
    pCmd : ^SVRCHCMD;
  END_STRUCT;
  CltChCmd_TestPositionTrigger : STRUCT
    pCh : ^SvrChCmd_DINT;
    dData : DINT;
    pCmd : ^TestPositionTrigger;
  END_STRUCT;
  ...
  CltChCmd_WatchdogDias : STRUCT
    ...
    pCmd : ^WatchdogDias;
  END_STRUCT;
  CltChCmd_X_Axle_Correction : STRUCT
    pCh : ^SvrChCmd_DINT;
    dData : DINT;
    pCmd : ^X_Axle_Correction;
  END_STRUCT;
  CltChCmd_Y_Axle_Correction : STRUCT
    pCh : ^SvrChCmd_DINT;
    dData : DINT;
    pCmd : ^Y_Axle_Correction;
  END_STRUCT;
  ...
  SvrCh_DS402_State : STRUCT
    ...
    pDsc : ^SVRDSC;
  END_STRUCT;
  SvrCh_ePauseOptions_PTofCls_PauseClass : STRUCT
    pMeth : ^CHMETH;
    dData : PauseClass::ePauseOptions;
    pDsc : ^SVRDSC;
  END_STRUCT;
  SvrCh_eTriggerType : STRUCT
    pMeth : ^CHMETH;
    dData : eTriggerType;
    pDsc : ^SVRDSC;
  END_STRUCT;
  ...
  SvrCh_OptiesEnum : STRUCT
    ...
    pDsc : ^SVRDSC;
  END_STRUCT;
  SvrCh_PauseFunctions : STRUCT
    pMeth : ^CHMETH;
    dData : PauseFunctions;
    pDsc : ^SVRDSC;
  END_STRUCT;
  SvrCh_REAL : STRUCT
    pMeth : ^CHMETH;
  ...
  SvrCh_SafetyConfigStateType : STRUCT
    ...
    pDsc : ^SVRDSC;
  END_STRUCT;
  SvrCh_SendCommand_PTofCls_Wecube_Communication : STRUCT
    pMeth : ^CHMETH;
    dData : Wecube_Communication::SendCommand;
    pDsc : ^SVRDSC;
  END_STRUCT;
  SvrCh_SendCommands_PTofCls_Camera_Master : STRUCT
    pMeth : ^CHMETH;
    dData : Camera_Master::SendCommands;
    pDsc : ^SVRDSC;
  END_STRUCT;
  SvrCh_SoortCheck : STRUCT
    pMeth : ^CHMETH;
    dData : SoortCheck;
    pDsc : ^SVRDSC;
  END_STRUCT;
