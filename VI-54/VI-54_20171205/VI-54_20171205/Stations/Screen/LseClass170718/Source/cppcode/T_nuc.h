...
class _TextList
{
  private :
    ...
    _UDWORD         HostLanguagePushPopCnt;
    _UDWORD         HostLanguageNo;
  ...
  public :
    ...
    _BOOL       HostLanguageSet(_UDWORD language);
    _BOOL       HostLanguagePush(void);
    _BOOL       HostLanguagePop(void);
