...
#define SA33569
#define SA35926 // multiple alarmconfig
...
//    SaveAlarmCrc();
    ...
    if(doubleconfig != 0)
    {
      ScanBar.End(ScanBar.Add("WARNING: AlarmConfigNumber multiple used, check TraceView for details.", 0, MakeColor(BLACK, YELLOW)));
    }
   #endif // SA35926 
  }
